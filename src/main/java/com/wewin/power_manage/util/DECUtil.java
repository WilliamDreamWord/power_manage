...
public class DECUtil {
    ...
    public String encrypt(String unencryptedPwd) {

        DECUtil decUtil = new DECUtil();
        String type = "encrypt";
        return decUtil.encrypt(unencryptedPwd, key, type);
    }

    public String decipher(String encryptedPwd) {

        DECUtil decUtil = new DECUtil();
        String type = "decrypt";
        return decUtil.encrypt(encryptedPwd, key, type);
    }
